...
import { Model, ModelReference, applyReferenceRotation, ModelStorage } from './model';
...
export function applyReferences(blockstate: FileRef<Variants>, models: ModelStorage, generatedModels: ModelStorage) {
